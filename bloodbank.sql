...
insert into admin (first_name, last_name, gender, dob, phoneno, username, pwd)values ('Bharagvi', 'Madhavan', 'Female', '2000-10-11', 8056978222, 'bhargavi11102000@gmail.com', 'bharpwd123');
insert into admin (first_name, last_name, gender, dob, phoneno, username, pwd) values ('Nikkitha', 'G S', 'Female', '2000-08-08', 9840589649, 'gsnikkitha88@gmail.com', 'nikkpwd123');
